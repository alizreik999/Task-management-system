    ...
    <div name='home' className='w-full h-screen  flex flex-col justify-between'>
        <div className='grid md:grid-cols-2 max-w-[1240px] m-auto'>
            <div className='flex flex-col justify-center md:items-start w-full px-2 py-8'>
                <h1 className='py-3   text-5xl md:text-5xl font-bold'>Task <span className='text-indigo-600'>Managment</span> </h1>
                <p className='text-lg pt-2 pb-4'> A user-friendly platform for seamless task collaboration, empowering teams to efficiently add, organize, and track tasks within projects.</p>
